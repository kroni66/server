...
CPacketInfoCG::CPacketInfoCG()
{
	...
	Set(HEADER_CG_ATTENDANCE, sizeof(TPacketCGAttendance), "Attendance", true);
#endif
	...
	Set(HEADER_CG_BUY_ITEMSHOP_ITEM, sizeof(TPacketCGBuyItemshopItem), "BuyItemshopItem", true);
	Set(HEADER_CG_PROMOTION, sizeof(TPacketCGRedeemPromotionCode), "RedeemPromotionCode", true);
#endif
#ifdef FLY_SYSTEM
	Set(HEADER_GC_NEW_MOVEMENTS, sizeof(TPacketNewMovement), "RecvNewMovements", true);
#endif
