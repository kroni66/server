...
#endif
#ifdef FLY_SYSTEM
	HEADER_GC_NEW_MOVEMENTS	= 219,
#endif
#ifdef ENABLE_ITEMSHOP
	HEADER_CG_BUY_ITEMSHOP_ITEM = 242,
	HEADER_CG_PROMOTION = 241,
	HEADER_GC_ITEMSHOP = 242,
#endif
#if defined(__PLAYER_PIN_SYSTEM__)
	HEADER_CG_PLAYER_PIN_CODE = 243,
#endif
...
#ifdef FLY_SYSTEM
typedef struct command_new_movements_packet
{
	BYTE header;
	DWORD vid;
	int type;
...
enum EAttendanceHeader
{
	HEADER_GC_ATTENDANCE = 244,
	HEADER_CG_ATTENDANCE = 244,
};

enum EAttendanceSubHeader
{
	SUBHEADER_ATTENDANCE_CLOSE,
	SUBHEADER_ATTENDANCE_OPEN,
	SUBHEADER_ATTENDANCE_COLLECT,
};

typedef struct SPacketGCAttendanceItem
{
	DWORD dwVNum;
	BYTE bCount;
	BYTE bState;
} TPacketGCAttendanceItem;

typedef struct SPacketGCAttendance
{
	BYTE bHeader;
	WORD wSize;
} TPacketGCAttendance;

typedef struct SPacketCGAttendance
{
	BYTE bHeader;
	BYTE bSubHeader;
} TPacketCGAttendance;
